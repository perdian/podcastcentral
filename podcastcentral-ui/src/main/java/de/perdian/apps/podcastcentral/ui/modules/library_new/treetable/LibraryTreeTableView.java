...
public class LibraryTreeTableView extends TreeTableView<LibraryTreeItemValue> {
    ...
    public LibraryTreeTableView(Library library, Localization localization) {
        ...
        this.getColumns().add(LibraryTreeTableColumnFactory.createColumn(localization.title(), LibraryTreeItemValue::getTitle));

        this.setRoot(LibraryTreeItemFactory.createLibraryRootItem(library));

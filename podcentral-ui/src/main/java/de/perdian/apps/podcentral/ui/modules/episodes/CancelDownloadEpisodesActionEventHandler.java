...
public class CancelDownloadEpisodesActionEventHandler implements EventHandler<ActionEvent> {
    ...
    public CancelDownloadEpisodesActionEventHandler(Supplier<List<Episode>> episodesSupplier, BackgroundTaskExecutor backgroundTaskExecutor, EpisodeContentDownloader episodeContentDownloader, Localization localization) {
